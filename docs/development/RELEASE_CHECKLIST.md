# Checklist de livraison — 5.1.1

Cette checklist concerne la livraison Windows `5.1.1`. Ne distribuez pas l’artefact si une étape de blocage échoue.

## 1. Préparer un checkout propre

- [ ] Confirmer la version `5.1.1` dans `pyproject.toml`, `app/backend/core/config.py` et `CHANGELOG.md`.
